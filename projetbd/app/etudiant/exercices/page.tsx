        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <Link href="/etudiant" className="flex items-center space-x-2">
...
GROUP BY c.customer_name;`}</code>
          ...
          <div className="space-y-6">
            ...
            <button
                className={`w-full py-2 px-4 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg transition-colors duration-300 flex items-center justify-center ${!uploadedFile ? "opacity-70 cursor-not-allowed" : ""}`}
